...
(songplay_id SERIAL, \
start_time bigint, user_id int, level varchar, song_id varchar, \
...
name varchar, location varchar, lattitude numeric, longitude numeric);
""")

time_table_create = ("""CREATE TABLE IF NOT EXISTS time (start_time bigint, hour int, \
